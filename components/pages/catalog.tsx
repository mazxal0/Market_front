...
import {getAllProcessors} from "@/api/catalog";
...
export default function CatalogPage() {
  ...
  return (
    <>
          ...
          {isLoading ? <Loader/> :
            (processors && processors.slice(0, limit).map((item: ProductForCatalog) => (
              <ProductCardCatalog
                ...
                setGlobalTypeId={setGlobalCurrentProductId}
                setGlobalType={setGlobalCurrentProductType}
              />
            ))
      ...
      <ProductModal productType={globalCurrentProductType} productId={globalCurrentProductId}
                    isModalOpen={isOpenProduct} setModalOpen={setIsOpenProduct}/>
    </>
  )
}
